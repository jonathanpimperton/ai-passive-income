---
title: "Lump Sum vs Dollar-Cost Averaging: How to Invest a Windfall"
slug: "lump-sum-vs-dollar-cost-averaging"
description: "Compare lump sum investing with dollar-cost averaging. See historical win rates, the maths behind each strategy, and which approach suits your situation."
keywords:
...
comparisonTable:
  - feature: "Historical win rate"
    option1: "~67% of the time"
    option2: "~33% of the time"
  - feature: "Average extra return"
    option1: "2.3% over 12-month DCA period"
    option2: "—"
  - feature: "Maximum regret"
    option1: "High — could invest right before a crash"
    option2: "Low — only part of money is at risk"
  - feature: "Time in market"
    option1: "Immediate full exposure"
    option2: "Gradually increases over months"
  - feature: "Emotional comfort"
    option1: "Stressful if markets drop after investing"
    option2: "Easier — feels like a safer approach"
  - feature: "Best for"
    option1: "Long time horizons, high risk tolerance"
    option2: "Nervous investors, large amounts"
  - feature: "Opportunity cost"
    option1: "None — money is working immediately"
    option2: "Cash waiting to be invested earns little"
affiliateContext: "Where to invest your windfall"
affiliatePrograms:
  - "Betterment"
  - "InvestEngine"
