---
title: "Index Funds vs Active Funds: Where Should You Invest?"
slug: "index-funds-vs-active-funds"
description: "Compare index funds and actively managed funds. See the real impact of fees on long-term returns and which approach wins over 10, 20, and 30 years."
keywords:
  - "index funds vs active funds"
  - "passive vs active investing"
  - "index fund fees comparison"
relatedTools:
  - "investment-return"
  - "compound-interest"
  - "roi"
...
comparisonTable:
  - feature: "Typical annual fee (expense ratio)"
    option1: "0.03–0.20%"
    option2: "0.50–1.50%"
  - feature: "Fee on $100K over 30 years"
    option1: "$2,800 (at 0.10%)"
    option2: "$49,000 (at 1.00%)"
  - feature: "% that beat the index (15 years)"
    option1: "Matches the index by design"
    option2: "~12% of funds"
  - feature: "Strategy"
    option1: "Buy everything in the market"
    option2: "Fund manager picks stocks"
  - feature: "Tax efficiency"
    option1: "High — low turnover"
    option2: "Low — frequent trading creates taxable events"
...
1. **US total stock market index** (e.g., VTI, FSKAX) — 0.03% expense ratio
2. **International stock index** (e.g., VXUS, FTIHX) — 0.07% expense ratio
3. **US bond index** (e.g., BND, FXNAX) — 0.03% expense ratio
