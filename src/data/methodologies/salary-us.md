...
variables:
  ...
  - name: "401(k)"
    description: "Pre-tax retirement contribution as a percentage of gross income, capped at the IRS limit ($23,500 for 2025)"
  - name: "Filing Status"
...
limitations:
  ...
  - "401(k) catch-up contributions for age 50+ ($7,500 additional) are not modeled"
dataSources:
...
**Social Security:** 6.2% on the first $176,100 of wages (2025 wage base). Income above this cap is exempt. Maximum Social Security tax: $10,918.
...
401(k) contributions reduce federal and state taxable income but do not reduce FICA wages. The IRS contribution limit for 2025 is $23,500 (under age 50). The calculator caps contributions at this limit.
