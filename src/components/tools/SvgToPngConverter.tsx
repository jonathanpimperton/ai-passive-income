    ...
    <div className="grid grid-cols-1 lg:grid-cols-5 gap-6">
      <div className="lg:col-span-2 space-y-5">
        ...
        <FileDropZone
          ...
          onFiles={handleFiles}
        />
        <div className="bg-white rounded-lg border border-neutral-200/80 shadow-card p-5">
          <SliderInput
            label="Scale"
            id="svg-scale"
            value={scale}
      ...
      <div className="lg:col-span-3 space-y-4" aria-live="polite">
        ...
        {pngPreview && file ? (
          <div className="space-y-4">
            <div className="bg-white rounded-lg border border-neutral-200/80 shadow-card p-4 overflow-hidden">
            ...
            <div className="flex items-center justify-between">
              <p className="text-sm text-neutral-600">
                ...
                <span className="text-neutral-500 ml-2">({formatSize(pngSize)})</span>
              </p>
              <button
                onClick={download}
                className="inline-flex items-center gap-2 px-4 py-2.5 text-sm font-medium text-white bg-primary-600 hover:bg-primary-700 rounded-lg transition-colors duration-150"
              >
