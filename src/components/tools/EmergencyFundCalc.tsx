      ...
      <div className="grid grid-cols-1 lg:grid-cols-[2fr_3fr]">
        ...
        <div className="p-6 lg:p-8 lg:border-r border-neutral-100">
          ...
          <div className="space-y-5">
            <SliderInput label="Housing / Rent" id="ef-housing" value={housing} min={0} max={5000} step={50} onChange={setHousing} prefix="$" formatDisplay={formatNumber} />
            ...
            <SliderInput label="Insurance" id="ef-insurance" value={insurance} min={0} max={2000} step={25} onChange={setInsurance} prefix="$" formatDisplay={formatNumber} />
